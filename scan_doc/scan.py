...
from scan_doc.pyimagesearch import transform
from scan_doc.pyimagesearch import imutils
from scipy.spatial import distance as dist
from matplotlib.patches import Polygon
import scan_doc.polygon_interacter as poly_i
import numpy as np
...
class DocScanner(object):
    ...
    def __init__(self, OUTPUT_DIR=None, interactive=False, MIN_QUAD_AREA_RATIO=0.25, MAX_QUAD_ANGLE_RANGE=40):
        """
        Args:
    ...
    def get_lines(self, img):
            ...
            lines = result[0]  # Get the detected lines from the tuple
            return lines
    ...
    def scan(self, image_path):
        ...
        cv2.imwrite(self.OUTPUT_DIR + '/' + basename, sharpen)
